...
@Component({
  selector: 'app-get-radiation-info',
  templateUrl: './get-radiation-info.component.html',
  styleUrls: ['./get-radiation-info.component.css'],
})
export class GetRadiationInfoComponent implements OnInit {
